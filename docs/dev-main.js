window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=d2a795&fwbuild=dev"};
...
document.write('<script>goog.require("javierweiss.curso_sobre_el_poder");</script>');
